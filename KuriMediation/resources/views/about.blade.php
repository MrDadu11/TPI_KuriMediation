...
<body>
    <x-app-layout>
        <div class="md:mt-10 max-w-full md:max-w-7xl mx-auto">
            <div class="p-3 md:p-0 flex flex-col space-y-5">
                <section class="bg-gray-100 border border-gray-300 shadow-2xl rounded-xl py-12 text-justify px-8">
                ...
                <section class="bg-gray-100 border border-gray-300 shadow-2xl rounded-xl py-12 px-3 text-justify">
