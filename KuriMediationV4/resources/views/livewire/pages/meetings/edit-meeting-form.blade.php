<section>
    <form action="{{ route('meeting.update', ['meetingId' => $currentMeeting->id ]) }}" method="POST">
        ...
        <div class="flex items-center">
            ...
            <x-text-input wire:model="currentMeeting.name" class="rounded-lg border-gray-200 resize-none ml-2" id="name" name="name" placeholder="Nom de l'entretien" :value="$currentMeeting->name" required/>
        ...
        <div class="px-5 py-3 border rounded-lg shadow-md">
            <div class="flex justify-between items-center">
                ...
                <div class="flex flex-row xl:space-x-2 items-center">
                    ...
                    <div>
                        <label for="type_id" class="font-bold px-3 py-1 text-blue-800 text-lg border rounded-lg">Type:</label>
